...
## Corpus Check
- 159 files · ~80,451 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1078 nodes · 2069 edges · 112 communities (58 shown, 54 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df9dc8ba`
...
## Communities (112 total, 54 thin omitted)
...
Cohesion: 0.28
Nodes (10): fetchUploadDestination(), fetchUploadStatus(), strategyLabelKey(), UploadDestinationPreview(), UploadDropzone(), UploadDropzoneProps, uploadFileWithProgress(), UploadSessionStatus (+2 more)
...
Cohesion: 0.18
Nodes (19): GET(), RouteParams, GET(), RouteParams, DELETE(), PATCH(), RouteParams, POST() (+11 more)
...
Cohesion: 0.18
Nodes (5): dropboxAdapter, googleDriveAdapter, adapters, teraboxAdapter, yandexAdapter

### Community 17 - "utils.ts"
Cohesion: 0.14
Nodes (23): GET(), PROVIDER_PARAM_MAP, RouteParams, PATCH(), PROVIDER_PARAM_MAP, RouteParams, GET(), ActiveUpload (+15 more)
...
Cohesion: 0.15
Nodes (15): LoginForm(), RegisterForm(), fetchAccounts(), MyDriveView(), useLanguage(), SettingsPageContent(), fetchSettings(), UserSettings() (+7 more)

### Community 25 - "terabox.ts"
Cohesion: 0.22
Nodes (14): fetchAccounts(), HomeDashboard(), usagePercent(), StorageOverview(), usagePercent(), Card, CardContent, CardDescription (+6 more)

### Community 26 - "command.tsx"
Cohesion: 0.29
Nodes (8): fetchProviders(), ProviderConfigItem(), ProviderConfigItemProps, ProviderConfigPanel(), ProviderFormState, AccordionContent, AccordionItem, AccordionTrigger
...
Cohesion: 0.19
Nodes (11): ConnectGuideContent(), dropboxSteps, getAppUrl(), getProviderRedirectUri(), googleSteps, ProviderSetupCard(), ProviderSetupCardProps, teraboxSteps (+3 more)

### Community 35 - "FileExplorer"
Cohesion: 0.15
Nodes (17): AccountsPanel(), ConfirmAction, fetchAccounts(), fetchProviders(), ConnectAccountDialog(), fetchProviders(), providerIcons, Badge() (+9 more)
...
Cohesion: 0.16
Nodes (16): ConnectS3Form(), ConnectS3FormProps, ConnectTeraboxForm(), ConnectTeraboxFormProps, fetchAccounts(), fetchFolders(), MoveFileDialog(), Alert (+8 more)
...
Cohesion: 0.22
Nodes (3): GOOGLE_EXPORT_MIMES, SCOPES, QuotaInfo
...
### Community 44 - "slider.tsx"
Cohesion: 0.22
Nodes (8): AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter(), AlertDialogHeader(), AlertDialogOverlay, AlertDialogTitle

### Community 46 - "tabs.tsx"
Cohesion: 0.11
Nodes (11): HoverCardContent, InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot, PopoverContent, RadioGroup, RadioGroupItem (+3 more)
...
Cohesion: 0.24
Nodes (5): s3Adapter, S3Credentials, NormalizedFile, OAuthProviderConfig, ProviderCredentials

### Community 73 - "createClient"
Cohesion: 0.20
Nodes (12): DELETE(), deleteFileMetadataBatched(), GET(), GET(), GET(), GET(), GET(), PATCH() (+4 more)

### Community 75 - "sync.ts"
Cohesion: 0.19
Nodes (14): POST(), getOneDriveSpecialFolder(), getValidCredentials(), ONEDRIVE_SPECIAL_FOLDERS, Supabase, syncAccountPath(), syncOneDriveSpecialFolders(), SyncResult (+6 more)

### Community 76 - "index.ts"
Cohesion: 0.25
Nodes (10): readStoredLanguage(), en, id, detectBrowserLanguage(), dictionaries, getDictionary(), isLanguage(), translate() (+2 more)

### Community 98 - "accounts.ts"
Cohesion: 0.31
Nodes (8): POST(), POST(), saveAccount(), Supabase, decryptCredentials(), encryptCredentials(), getKey(), withTimeout()

### Community 101 - "file-explorer.tsx"
Cohesion: 0.16
Nodes (13): readStoredSortMode(), SORT_MODES, SortMode, ViewMode, Checkbox, Table, TableBody, TableCaption (+5 more)

### Community 105 - "route.ts"
Cohesion: 0.29
Nodes (9): cookieOpts(), GET(), oauthRedirect(), PROVIDER_PARAM_MAP, RouteParams, shortError(), waitThenFinalize(), buildOAuthReturnUrl() (+1 more)

### Community 106 - "FileExplorer"
Cohesion: 0.20
Nodes (4): fetchFiles(), FileExplorer(), readStoredViewMode(), sortFiles()

### Community 107 - "toggle-group.tsx"
Cohesion: 0.33
Nodes (5): ToggleGroup, ToggleGroupContext, ToggleGroupItem, Toggle, toggleVariants

### Community 108 - "allocation-settings.tsx"
Cohesion: 0.29
Nodes (9): ConnectAccountDialogProps, StorageOverviewProps, AllocationSettings(), AllocationSettingsProps, fetchAllocation(), STRATEGIES, strategyDescKey(), strategyLabelKey() (+1 more)
